...
var Client = function(wsdl, without_tns, endpoint) {
  this.wsdl = wsdl;
  this.without_tns = without_tns
...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  ...
  if (input.parts) {
    ...
    message = self.wsdl.objectToDocumentXML(input.$name, args, input.targetNSAlias, input.targetNamespace, input.$type, this.without_tns);
  }
  xml = "<soap:Envelope " +
